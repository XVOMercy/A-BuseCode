...
/*
	Format:
	to_chat(H, "<center><b>For more information on how the station works, see <a href=\"[LINK]\">Standard Operating Procedure (SOP)</a>.</b></center>")
*/
	...
	to_chat(H, "<center><b>For more information on how the station works, see... oh, looks like that doesn't exist yet...</a>.</b></center>")
	if(job.is_service)
		to_chat(H, "<center><b>As a member of the Service department, make sure to read up on your... oh, looks like that doesn't exist yet...</b>.</center>")
	if(job.is_supply)
		to_chat(H, "<center><b>As a member of the Supply department, make sure to read up on your... oh, looks like that doesn't exist yet...</b>.</center>")
	if(job.is_command)
		to_chat(H, "<center><b>As an important member of Command, read up on your... oh, looks like that doesn't exist yet...</b>.</center>")
	if(job.is_legal)
		to_chat(H, "<center><b>Your job requires complete knowledge of... oh, looks like that doesn't exist yet...</b>.</center>")
	if(job.is_engineering)
		to_chat(H, "<center><b>As a member of the Engineering department, make sure to read up on your... oh, looks like that doesn't exist yet...</b>.</center>")
	if(job.is_medical)
		to_chat(H, "<center><b>As a member of the Medbay department, make sure to read up on your... oh, looks like that doesn't exist yet...</b>.</center>")
	if(job.is_science)
		to_chat(H, "<center><b>As a member of the Science department, make sure to read up on your... oh, looks like that doesn't exist yet...</b>.</center>")
	if(job.is_security)
		to_chat(H, "<center><b>As a member of the Security department, you are to know <a href=\"https://www.paradisestation.org/wiki/index.php/Space_law\">Space Law</a>, <a href=\"https://www.paradisestation.org/wiki/index.php/Legal_Standard_Operating_Procedure\">Legal Standard Operating Procedure</a>, as well as your <a href=\"https://www.paradisestation.org/wiki/index.php/Standard_Operating_Procedure_&#40;Security&#41\">Department SOP</a>.</b></center>")
	...
	to_chat(H, "<br><b><center>If you need help, check the wiki that doesn't exist yet, or use Mentorhelp(F1)!</b></center>")
